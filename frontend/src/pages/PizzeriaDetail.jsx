    ...
    <div className="min-h-screen bg-cream pb-8" data-testid="pizzeria-detail-page">
      ...
      <div className="px-4 -mt-4 relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-md p-5 mb-6">
          ...
          {/* Contact Info */}
          {(pizzeria.website || pizzeria.phone || pizzeria.reservation_url) && (
            <div className="mt-4 pt-4 border-t border-stone/10 space-y-3">
              {pizzeria.phone && (
                <a 
                  href={`tel:${pizzeria.phone}`}
                  className="flex items-center gap-3 text-ink hover:text-brick transition-colors"
                  data-testid="phone-link"
                >
                  <div className="w-8 h-8 bg-olive/10 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-olive"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                  </div>
                  <span className="font-medium">{pizzeria.phone}</span>
                </a>
              )}
              {pizzeria.website && (
                <a 
                ...
                >
                  <div className="w-8 h-8 bg-brick/10 rounded-full flex items-center justify-center">
                    <ExternalLink size={16} className="text-brick" />
                  </div>
                  <span className="font-medium">Visit Website</span>
                </a>
              )}
              {pizzeria.reservation_url && (
                <a 
                  href={pizzeria.reservation_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-brick text-white px-4 py-3 rounded-lg hover:bg-brick-hover transition-colors justify-center font-heading uppercase tracking-wider text-sm"
