...
async def seed_data():
    ...
    pizzerias = [
        ...
        },
        {
            ...
            "website": "https://www.daroco.com/en/daroco-bourse/",
            "phone": "+33 1 42 21 93 71",
            "reservation_url": "https://www.daroco.com/en/daroco-bourse/",
            "opening_hours": {"lunch": "12:00-14:30", "dinner": "19:00-22:30"},
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
        ...
        },
        {
            ...
            "phone": "+33 1 43 42 27 56",
            "reservation_url": "https://www.passerini.paris",
            "opening_hours": {"lunch": "12:00-14:30", "dinner": "19:00-22:30"},
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "website": "https://www.mammaroma.com",
            "phone": "+33 1 46 06 96 36",
            "reservation_url": None,
            "opening_hours": {"lunch": "12:00-14:30", "dinner": "19:00-22:30"},
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        ...
        },
        {
            ...
            "recommended_by": ["Time Out", "Le Fooding"],
            "website": "https://faggioparis.com",
            "phone": "+33 1 42 33 94 33",
            "reservation_url": "https://faggioparis.com",
            "opening_hours": {"lunch": "12:00-14:30", "dinner": "19:00-22:30"},
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
        ...
        },
        {
            ...
            "filters": {"sourdough": False, "long_fermentation": True, "gluten_free": False, "italian_owners": False, "italian_pizzaiolo": True, "good_wine": True, "famous_tiramisu": False},
            "recommended_by": ["Le Fooding"],
            "website": "https://www.bonvivant.paris",
            "phone": "+33 1 43 26 51 34",
            "reservation_url": "https://www.bonvivant.paris/en/reservations",
            "opening_hours": {"lunch": "12:00-14:30", "dinner": "19:00-22:30"},
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "recommended_by": ["Le Fooding", "Gault & Millau"],
            "website": "https://www.marzo-paris.com",
            "phone": "+33 1 43 35 08 05",
            "reservation_url": None,
            "opening_hours": {"lunch": "12:00-14:30", "dinner": "19:00-22:30"},
            "created_at": datetime.now(timezone.utc).isoformat()
        },
